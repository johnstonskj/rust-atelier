...
const WEATHER_AS_LINES: &[&str] = &[
    ...
    "operation::example.weather#GetCity::output=>example.weather#GetCityOutput",
    "operation::example.weather#GetCity::trait::smithy.api#readonly<={}",
    "operation::example.weather#GetCurrentTime",
    "operation::example.weather#GetCurrentTime::output=>example.weather#GetCurrentTimeOutput",
    ...
    "operation::example.weather#GetForecast::output=>example.weather#GetForecastOutput",
    ...
    "operation::example.weather#ListCities::output=>example.weather#ListCitiesOutput",
